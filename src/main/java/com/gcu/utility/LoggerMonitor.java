...
/**
 * Advise class that will log a method when it is called and ended.
 * 
 * @author Michael M
 *
 */
...
{
	//Logger, Class is ca
	private static final Logger logger = LoggerFactory.getLogger("Topic 3-1");
	
	@Pointcut("execution(* com.gcu..controller..*(..)) || execution(* com.gcu..business..*(..))")
	public void monitor()
	{
	}
